...
HRESULT CLoader::Loading_For_Tool_Map()
{
	...
	//	CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/Map/Map_Beach_NoWater.fbx", TEXT("Prototype_Component_Model_Map_Beach"), TransformMatrix))))
	//	return E_FAIL;

	///* For.Prototype_Component_Model_Map_Beach_WaterEdge */
	//TransformMatrix = /*XMMatrixScaling(100.f, 100.f, 100.f);*/XMMatrixIdentity();
	//if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Map_Beach_WaterEdge"),
	//	CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/Map/Water/Map_Beach_Water.fbx", TEXT("Prototype_Component_Model_Map_Beach_WaterEdge"), TransformMatrix))))
	//	return E_FAIL;

	///* For.Prototype_Component_Model_Map_Beach_WaterEdge */
	//TransformMatrix = /*XMMatrixScaling(100.f, 100.f, 100.f);*/XMMatrixIdentity();
	//if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Map_Beach_WaterBlue"),
	//	CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/Map/Water/map_beach_water_blue.fbx", TEXT("Prototype_Component_Model_Map_Beach_WaterBlue"), TransformMatrix))))
	//	return E_FAIL;

	///* For.Prototype_Component_Model_Map_Beach_WaterEdge */
	//TransformMatrix = /*XMMatrixScaling(100.f, 100.f, 100.f);*/XMMatrixIdentity();
	//if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Map_Beach_WaterDepth"),
	//	CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/Map/Water/map_beach_water_depth.fbx", TEXT("Prototype_Component_Model_Map_Beach_WaterDepth"), TransformMatrix))))
	//	return E_FAIL;
	...
	/*TransformMatrix = XMMatrixIdentity();
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Monster_Crab"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Models/Monster/Crab/crabbo (merge).fbx", TEXT("Prototype_Component_Model_Monster_Crab"), TransformMatrix))))
		return E_FAIL;*/

	/*TransformMatrix = XMMatrixIdentity();
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Monster_Guard"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Models/Monster/Guard/Honourguard.fbx", TEXT("Prototype_Component_Model_Monster_Guard"), TransformMatrix))))
		return E_FAIL;

	TransformMatrix = XMMatrixIdentity();
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Monster_Guard_Shield"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/Monster/Guard/Honourguard_Shield.fbx", TEXT("Prototype_Component_Model_Monster_Guard_Shield"), TransformMatrix))))
		return E_FAIL;

	TransformMatrix = XMMatrixIdentity();
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Monster_Guard_Spear"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/Monster/Guard/Honourguard_Spear.fbx", TEXT("Prototype_Component_Model_Monster_Guard_Spear"), TransformMatrix))))
		return E_FAIL;*/

	/*TransformMatrix = XMMatrixIdentity();
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Monster_Frog"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Models/Monster/Frog/Frog.fbx", TEXT("Prototype_Component_Model_Monster_Frog"), TransformMatrix))))
		return E_FAIL;

	TransformMatrix = XMMatrixIdentity();
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Monster_Frog_Scimitar"),
	...
	/*TransformMatrix = XMMatrixIdentity();
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Effect_Sphere"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/Object/Sphere/Sphere.fbx", TEXT("Prototype_Component_Model_Effect_Sphere"), TransformMatrix))))
		return E_FAIL; */

	/*TransformMatrix = XMMatrixIdentity();
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Object_Menue_Sword"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/Object/Menu/Menu_Sword.fbx", TEXT("Prototype_Component_Model_Object_Menue_Sword"), TransformMatrix))))
		return E_FAIL;*/

	/*TransformMatrix = XMMatrixIdentity();
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Object_Teleport"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/Object/Teleport/Teleport.fbx", TEXT("Prototype_Component_Model_Object_Teleport"), TransformMatrix))))
		return E_FAIL;*/

	TransformMatrix = XMMatrixIdentity();
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_TOOL_MAP, TEXT("Prototype_Component_Model_Object_Bridge"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/Object/Bridge/Bridge5.fbx", TEXT("Prototype_Component_Model_Object_Bridge"), TransformMatrix))))
		return E_FAIL;

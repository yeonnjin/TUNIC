...
void CLevel_GamePlay::Tick(_float fTimeDelta)
{
	...
	if (0 == m_pGameInstance->Get_Object_Count(LEVEL_GAMEPLAY, TEXT("Layer_Monster")))
	{
		...
		if (FAILED(m_pGameInstance->Add_Clone(LEVEL_GAMEPLAY, TEXT("Layer_Monster"), TEXT("Prototype_GameObject_Monster_Frog"), &tDesc)))
			return;*/
		...
		if (FAILED(m_pGameInstance->Add_Clone(LEVEL_GAMEPLAY, TEXT("Layer_Monster"), TEXT("Prototype_GameObject_Monster_Blob"), &tDesc)))
			return;*/

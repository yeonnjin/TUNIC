...
CGuard_Weapon_Shield::CGuard_Weapon_Shield(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : CPartObject{ pDevice, pContext }
{
}

CGuard_Weapon_Shield::CGuard_Weapon_Shield(const CGuard_Weapon_Shield& rhs)
    : CPartObject{ rhs }
{
}

HRESULT CGuard_Weapon_Shield::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CGuard_Weapon_Shield::Initialize(void* pArg)
{
    GUARD_WEAPON_SHIELD_DESC* pDesc = (GUARD_WEAPON_SHIELD_DESC*)pArg;
...
HRESULT CGuard_Weapon_Shield::Tick(_float fTimeDelta)
{
...
void CGuard_Weapon_Shield::Late_Tick(_float fTimeDelta)
{
...
HRESULT CGuard_Weapon_Shield::Render()
{
...
HRESULT CGuard_Weapon_Shield::Render_LightDepth()
{
...
HRESULT CGuard_Weapon_Shield::Add_Components()
{
    /* For.Com_Shader */
...
HRESULT CGuard_Weapon_Shield::Bind_ShaderResources()
{
    if (nullptr == m_pShaderCom)
        return E_FAIL;
...
{
    CGuard_Weapon_Shield* pInstance = new CGuard_Weapon_Shield(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX(TEXT("Failed To Create : CGuard_Weapon_Shield"));
...
CGameObject* CGuard_Weapon_Shield::Clone(void* pArg)
{
    CGuard_Weapon_Shield* pInstance = new CGuard_Weapon_Shield(*this);

    if (FAILED(pInstance->Initialize(pArg)))
    {
        MSG_BOX(TEXT("Failed To Clone : CGuard_Weapon_Shield"));
...
void CGuard_Weapon_Shield::Free()
{
    __super::Free();
...
void CGuard_Weapon_Shield::Collision_Event(Engine::CGameObject* pGameObject)
{
}

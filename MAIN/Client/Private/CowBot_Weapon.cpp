...
CCowBot_Weapon::CCowBot_Weapon(const CCowBot_Weapon& rhs)
    : CPartObject{ rhs }
{
}

HRESULT CCowBot_Weapon::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CCowBot_Weapon::Initialize(void* pArg)
{
    COWBOT_WEAPON_DESC* pDesc = (COWBOT_WEAPON_DESC*)pArg;
...
HRESULT CCowBot_Weapon::Tick(_float fTimeDelta)
{
...
void CCowBot_Weapon::Late_Tick(_float fTimeDelta)
{
...
HRESULT CCowBot_Weapon::Render_LightDepth()
{
...
HRESULT CCowBot_Weapon::Add_Components()
{
    /* For.Com_Shader */
...
HRESULT CCowBot_Weapon::Bind_ShaderResources()
{
    if (nullptr == m_pShaderCom)
        return E_FAIL;
...
CCowBot_Weapon* CCowBot_Weapon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CCowBot_Weapon* pInstance = new CCowBot_Weapon(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX(TEXT("Failed To Create : CCowBot_Weapon"));
...
CGameObject* CCowBot_Weapon::Clone(void* pArg)
{
    CCowBot_Weapon* pInstance = new CCowBot_Weapon(*this);

    if (FAILED(pInstance->Initialize(pArg)))
    {
        MSG_BOX(TEXT("Failed To Clone : CCowBot_Weapon"));

...
class CGuard_State_Idle final : public CState
{
private:
	CGuard_State_Idle(class CMonster_Guard* pMonster, class CPlayer* pPlayer);
	virtual ~CGuard_State_Idle() = default;
...
public:
	static CGuard_State_Idle* Create(class CMonster_Guard* pMonster, class CPlayer* pPlayer);
